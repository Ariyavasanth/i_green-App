...
class _TopBar extends StatelessWidget {
  const _TopBar({required this.compact, required this.expanded, required this.onMenuPressed});
  final bool compact;
  final bool expanded;
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(children: [
          ...
          const Expanded(child: Text('My Organization', style: AppTextStyles.heading)),
...
class _Sidebar extends StatelessWidget {
  const _Sidebar({required this.currentLocation, required this.expanded, required this.onSelected});
  final String currentLocation;
  final bool expanded;
