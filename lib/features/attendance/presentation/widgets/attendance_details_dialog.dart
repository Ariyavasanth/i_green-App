...
class AttendanceDetailsDialog extends StatelessWidget {
    ...
    if (record!.status.trim().toLowerCase() == 'late' && record!.effectiveCheckInTime.isNotEmpty) {
      try {
        ...
        if (inParts != null && actualParts != null) {
          final delay = actualParts - inParts;
  ...
  int? _parseTimeStringToMinutes(String timeStr) {
    try {
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            CircleAvatar(
                              ...
                              child: (employee.profileImageUrl.isEmpty || !employee.profileImageUrl.startsWith('http'))
                                  ? Text(
                                      ...
                                      style: const TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF414A51), fontSize: 15),
                                    )
                                  : null,
                            ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: status != null ? status.bgColor.withValues(alpha: 0.45) : const Color(0xFFF1F5F9),
                          borderRadius: BorderRadius.circular(10),
                          border: Border.all(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Row(
                                children: [
                                  const Icon(Icons.calendar_today, size: 14, color: Color(0xFF414A51)),
                ...
                children: [
                  if (onEdit != null) ...[
                    OutlinedButton.icon(
                      ...
                      label: const Text('Edit / Override', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
                      onPressed: () {
