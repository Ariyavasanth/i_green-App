...
class _ResponsesPageState extends ConsumerState<ResponsesPage> {
          ...
          Expanded(
            child: employeesAsync.when(
              ...
              data: (employees) {
                ...
                final orgList = [
                  ...
                  ...{
                    for (final e in employees)
                      if (e.organizationName.isNotEmpty) e.organizationName,
                  },
                ];
                final deptList = [
                  'All Departments',
                ...
                final pageIndex =
                    _currentPage.clamp(0, (totalPages - 1).clamp(0, 999));
  ...
  Widget _buildToolbar(
    ...
    final searchController = TextEditingController(
      text: ref.read(responseSearchQueryProvider),
    );
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: searchController.text.isNotEmpty
                            ? IconButton(
                                ...
                                onPressed: () {
                                  ref
                                      .read(responseSearchQueryProvider.notifier)
                                      .state = '';
      ...
      child: Wrap(
        ...
        children: [
          ...
          if (currentOrg != 'All Organizations' ||
            ...
            TextButton(
              onPressed: () {
                ref.read(responseOrgFilterProvider.notifier).state =
                    'All Organizations';
                ref.read(responseDeptFilterProvider.notifier).state =
                    'All Departments';
  ...
  Future<void> _updateEmployeeStatus(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
            'Response status updated to "$newStatus" for ${emp.fullName}'),
        behavior: SnackBarBehavior.floating,
      ),
    );
  }
  ...
  Widget _buildDesktopTable(
    ...
    final minTableWidth =
        (visibleColumns.length * 140.0 + 300.0).clamp(800.0, 3200.0);
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      ...
                      onPressed: () =>
                          _updateEmployeeStatus(context, emp, 'Rejected'),
                      icon: const Icon(Icons.cancel_outlined,
                          size: 16, color: Colors.redAccent),
