...
class IncentiveColumnSelectionDialog extends ConsumerStatefulWidget {
  const IncentiveColumnSelectionDialog({super.key});

  @override
  ConsumerState<IncentiveColumnSelectionDialog> createState() => _IncentiveColumnSelectionDialogState();
}

class _IncentiveColumnSelectionDialogState extends ConsumerState<IncentiveColumnSelectionDialog> {
  ...
  void initState() {
    super.initState();
    final allColumns = ref.read(incentiveAllColumnsProvider);
    final currentOrder = ref.read(incentiveColumnOrderProvider);
    final currentVisible = ref.read(incentiveVisibleColumnsProvider);
  ...
  void _resetToDefault() {
    final all = ref.read(incentiveAllColumnsProvider);
    setState(() {
  ...
  void _save() {
    ...
    ref.read(incentiveColumnOrderProvider.notifier).state = List.from(_orderedColumns);
    ref.read(incentiveVisibleColumnsProvider.notifier).state = newVisible;
